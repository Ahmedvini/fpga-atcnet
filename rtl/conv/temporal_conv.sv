...
module temporal_conv #(
    ...
    parameter signed [COEF_WIDTH-1:0] COEFF0 = 0,
parameter signed [COEF_WIDTH-1:0] COEFF1 = 0,
parameter signed [COEF_WIDTH-1:0] COEFF2 = 0,
parameter signed [COEF_WIDTH-1:0] COEFF3 = 0,
parameter signed [COEF_WIDTH-1:0] COEFF4 = 0
) (
    input  logic clk,
    input  logic rst,
